...
export const metadata: Metadata = {
  title: "Terms of Service | EchoPulse",
  description: "Terms of Service for EchoPulse - Professional content creation services including short-form video, podcast production, and social media content packages.",
  openGraph: {
    title: "Terms of Service | EchoPulse",
    description: "Terms of Service for EchoPulse - Professional content creation services.",
    type: "website",
  },
};
