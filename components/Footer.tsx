      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="py-12 sm:py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              <li>
                <a className="text-white/60 hover:text-orange-500 transition-colors flex items-center gap-2 group py-1 min-h-[40px] sm:min-h-0" href="#our-work">
                  <span className="w-0 group-hover:w-2 h-px bg-orange-500 transition-all"></span>
                  Our Work
                </a>
              </li>
              <li>
                <a className="text-white/60 hover:text-orange-500 transition-colors flex items-center gap-2 group py-1 min-h-[40px] sm:min-h-0" href="#how-we-work">
                  <span className="w-0 group-hover:w-2 h-px bg-orange-500 transition-all"></span>
                  How We Work
                </a>
              </li>
              <li>
                <a className="text-white/60 hover:text-orange-500 transition-colors flex items-center gap-2 group py-1 min-h-[40px] sm:min-h-0" href="#faq">
                  <span className="w-0 group-hover:w-2 h-px bg-orange-500 transition-all"></span>
                  FAQ
                </a>
              </li>
              <li>
                <Link className="text-white/60 hover:text-orange-500 transition-colors flex items-center gap-2 group py-1 min-h-[40px] sm:min-h-0" href="/blogs">
                  <span className="w-0 group-hover:w-2 h-px bg-orange-500 transition-all"></span>
                  Blog
                </Link>
              </li>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm">
              <li>
                <a className="text-white/60 hover:text-orange-500 transition-colors flex items-center gap-2 group py-1 min-h-[40px] sm:min-h-0" href="mailto:hello@echopulse.com">
                  <span className="w-0 group-hover:w-2 h-px bg-orange-500 transition-all"></span>
                  Email Us
                </a>
              </li>
              ...
              <li>
                <Link className="text-white/60 hover:text-orange-500 transition-colors flex items-center gap-2 group py-1 min-h-[40px] sm:min-h-0" href="/terms">
                  <span className="w-0 group-hover:w-2 h-px bg-orange-500 transition-all"></span>
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link className="text-white/60 hover:text-orange-500 transition-colors flex items-center gap-2 group py-1 min-h-[40px] sm:min-h-0" href="/privacy">
                  <span className="w-0 group-hover:w-2 h-px bg-orange-500 transition-all"></span>
                  Privacy Policy
                </Link>
              </li>
        ...
        <div className="py-6 flex justify-center items-center">
          <p className="text-xs sm:text-sm text-white/60 text-center">
            {currentYear} EchoPulse. All rights reserved.
          </p>
        </div>
        ...
        <div className="py-6 border-t border-white/10 text-center">
          <div className="flex flex-wrap justify-center items-center gap-3 sm:gap-6 text-xs sm:text-sm px-4">
            <Link href="/terms" className="text-white/60 hover:text-orange-500 transition-colors min-h-[44px] flex items-center">
              Terms of Service
            </Link>
            <span className="text-white/20 flex items-center">•</span>
            <Link href="/privacy" className="text-white/60 hover:text-orange-500 transition-colors min-h-[44px] flex items-center">
              Privacy Policy
            </Link>
          </div>
        </div>
