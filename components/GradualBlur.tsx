...
const mergeConfigs = (...configs: Partial<Config>[]): Config => {
  return configs.reduce<Config>((acc, c) => ({ ...acc, ...c }), { ...DEFAULT_CONFIG });
};
...
export default function GradualBlur(props: GradualBlurProps) {
  ...
  const config = useMemo(() => {
    ...
    return mergeConfigs(DEFAULT_CONFIG, presetConfig, props as Partial<typeof DEFAULT_CONFIG>);
  }, [props]);
  ...
  const blurDivs = useMemo(() => {
    ...
    const currentStrength =
      isHovered && props.hoverIntensity ? config.strength * props.hoverIntensity : config.strength;
  ...
  const containerStyle = useMemo((): React.CSSProperties => {
    ...
    return baseStyle;
  }, [config, isVisible, props.hoverIntensity]);
