...
const HeroShowreel = () => {
  ...
  const logos = [
    { name: 'Century 21', logo: '/logos/century 21.png' },
    { name: 'CIR Realty', logo: '/logos/CIR-REALTY_Logo_BLACK.jpg' },
    { name: 'EXP Realty', logo: '/logos/exp realty.png' },
    { name: 'Marcus & Millichap', logo: '/logos/marcus and millichap.png' },
    { name: 'Qualico', logo: '/logos/qualico.jpg' },
    { name: 'RE/MAX', logo: '/logos/remax.jpg' }
  ];
    ...
    <main className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 pt-24 pb-20 sm:px-6 sm:pt-28 sm:pb-24 lg:pt-40 lg:pb-24 lg:px-8 overflow-hidden">
      ...
      <div className="grid w-full max-w-7xl grid-cols-1 gap-8 sm:gap-12 xl:gap-20 xl:grid-cols-2 xl:items-center relative z-10">
        <div className="hero-text-desktop flex flex-col items-center xl:items-start gap-6 sm:gap-8 text-center xl:text-left w-full xl:-ml-8">
          <h1 className="font-black tracking-tighter text-white leading-[1.0] w-full pb-3" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
        ...
        <div className="parallax-container w-full relative mt-6 sm:mt-20 lg:mt-0">
          ...
          <div className="aspect-video w-full overflow-hidden glass-card glow parallax relative border border-white/10 shadow-2xl" style={{ borderRadius: '24px' }}>
            <video
              ref={videoRef}
