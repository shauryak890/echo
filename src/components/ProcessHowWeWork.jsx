   ...
   <section id="how-we-work" className="py-12 sm:py-16 relative overflow-hidden">
     ...
     <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl relative z-10">
       <div className="text-center mb-20">
         ...
         <h1 className="text-5xl font-extrabold text-white tracking-tight mb-4 animate-slide-up">
           Our Proven Process
         </h1>
       ...
       <div className="relative">
         {/* Enhanced vertical line for mobile view */}
         ...
         {steps.map((step, i) => (
           ...
           >
             {/* Enhanced Text Box section */}
             <div className="w-full md:w-5/12 ml-16 md:ml-0">
               <div className={`bg-gradient-to-br from-[#3a322f] to-[#2a2320] p-8 rounded-2xl border transition-all duration-500 group ${
                 hoveredStep === i 
                 ...
                 <div className={`space-y-3 ${i % 2 !== 0 ? "md:flex md:flex-col md:items-end" : ""}`}>
                   ...
                   {/* Deliverables dropdown on hover */}
...
export default ProcessHowWeWork;